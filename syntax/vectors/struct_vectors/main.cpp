...
int main()
{
    ...
    std::cout << vect.size() << std::endl;     // узнаем размер
    std::cout << vect.capacity() << std::endl; // узнаем емкость
    ...
    std::cout << vect[3].a << std::endl;
    std::cout << vect[4].a << std::endl;
    std::cout << vect[5].a << std::endl;
    std::cout << vect[6].a << std::endl;
    std::cout << vect[7].a << std::endl;
    std::cout << vect[8].a << std::endl;
