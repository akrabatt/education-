...
int main()
{
    ...
    std::cout << "element of array size: " << sizeof(employes[0]) << std::endl
              << std::endl; // размер одного элемента массива
    ...
    std::cout << "mass adr : " << employes + sizeof(employes) / sizeof(employes[0]) << std::endl
              << std::endl; // выведем размер последнего элемента для цикла
