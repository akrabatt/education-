...
int main() {
    ...
    for(ptr_1 = &arr[0]; ptr_1 < arr + sizeof(arr)/sizeof(arr[0]); ) {
        ...
        for(ptr_2 = &arr[0]; ptr_2 <= ptr_1; ptr_2++) {     //запускаем основной цикл
        ...
        if(!already_there) {    //если значения небыло в массиве и контролер не взведен, то...
